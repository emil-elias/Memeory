CREATE DATABASE IF NOT EXISTS `omemory`;
...
INSERT INTO `Level` (`level`, `anzahl_karten`, `spielZeit`)
VALUES (1, 4, 60);

INSERT INTO `Spieler` (`spielname`, `email`, `passwort`, `level`)
VALUES ("Max Mustermann", "mm@uni-bremen.de", "1234", 1),
("Erika Mustermann", "em@uni-bremen.de", "4567", 1);